...
$sqla="SELECT AccountNo,COUNT(*) FROM uniontemp WHERE rdate BETWEEN '$fd' AND '$fd2' GROUP BY AccountNo LIMIT 500";
//echo $sqla;
$result = mysql_query($sqla);
$show="<table border='1' width='500px'><br><br>";
$show.="<tr><td class=\"echoed_head\">Account </td><td class=\"echoed_head\">Count</td></tr>";
...
$show.="<tr><td class=\"result\">".$var."</td><td class=\"result\">".$var2."</td></tr>";
}
$show.="</table>";
...
<tr>
<td><div>
  <h2 style="color:#F60; font-size: 2em">Union Transaction Report (Account Number only)</h2></div></td>
</tr>
</table>
<br/>
<br/>
...
<tr>
  <td colspan="2">&nbsp;</td></tr>
<tr>
  <td colspan="2" class="mid"><span class="blue">>></span>To Download CSV file, Click On -->> <a href="accountonly.php?xx=<?php echo $_SESSION['fds'] ;?>&xy=<?php echo $_SESSION['fd2s'] ;?>" title="Click Here To Download CSV File">"DOWNLOAD"</a> After You Have Queried The Database</td>
</tr>
</table>
</form>
</td>
